       ...
       <aside className="w-full" aria-label="Sidebar">
          ...
          <div className="profile-header flex justify-between">
            <div className="profile-header-image">
               <img src="https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60" alt="profile-header-image"  className='w-[30px] h-[30px]'/>
            </div>
            <div className="profile-header-content">
               <h6 className="profile-header-name">John Doe</h6>
               <h3 className="profile-header-title">online</h3>
            </div>
          </div>
