  ...
  return (
    <div className="sidebar w-full">
       <aside className="w-full" aria-label="Sidebar">
          <div className="overflow-y-auto py-4 px-3 bg-[#94A8B6] rounded dark:bg-gray-800 w-full h-[100vh] text-white">
          <div className="profile-header flex justify-between w-[70%] items-center mx-auto">
            ...
            <div className="profile-header-content ml-2">
               <span className="profile-header-name block">John Doe</span>
               <span className="profile-header-title">online</span>
            </div>
          </div>
            <ul className="space-y-2">
               <li>
                  <a href="#" className="flex items-center p-2 text-base font-normal text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <ul className="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
               <li>
                  <a href="#" className="flex items-center p-2 text-base font-normal text-white rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                     <GrDiamond/>
