  ...
  return (
    <MainDiv>
       <div className='welcome text-center w-[70%] mx-auto'>
           <p className='text-2xl'>Welcome to <span className='text-blue-500 text-3xl'>{employeeData.username}</span> to onlineoffice where you connect to current working space</p>
